...
apps/server/
  drizzle.config.ts                         # generated by schema sync command
  src/db/
    schema.ts                               # generated composition entrypoint
    auth-schema.ts                          # generated by schema sync command
    plugins/                                # generated plugin schema fragment location
...
```ts
// apps/server/src/db/schema.ts (illustrative)
